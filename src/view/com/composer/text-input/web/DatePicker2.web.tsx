...
export interface DatePickerPosition {
  top: number
  left: number
  right: number
  bottom: number
...
export function DatePicker({state, close, pinToTop}: IProps) {
  ...
  const onInsert = (Date: Date) => {
    textInputWebEmitter.emit('Date-inserted', Date)
